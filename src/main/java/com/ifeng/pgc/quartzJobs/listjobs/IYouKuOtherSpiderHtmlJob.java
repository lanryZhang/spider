...
import com.ifeng.pgc.beans.IYouku_Other_VideoInfo;
 ...
 */
public class IYouKuOtherSpiderHtmlJob extends AbsHtmlJob {
    private IFlush<List<IYouku_Other_VideoInfo>> flusher;
    private VideoService videoService;
    public IYouKuOtherSpiderHtmlJob() {
        super(IYouku_Other_VideoInfo.class);
    }
    private Logger log = Logger.getLogger(IYouKuOtherSpiderHtmlJob.class);
    @Override
    public void doExecute(Context context) {
        ...
        try {
            ...
            List<IYouku_Other_VideoInfo> temp = item.get(IYouku_Other_VideoInfo.class.getName());
