...
import com.ifeng.pgc.beans.IYouku_I_VideoInfo;
 ...
 */
public class IYouKuISpiderHtmlJob extends AbsHtmlJob {
    private IFlush<List<IYouku_I_VideoInfo>> flusher;
    private List<IYouku_I_VideoInfo> list = new ArrayList<>();
    private VideoService videoService;
    private Logger log = Logger.getLogger(IYouKuISpiderHtmlJob.class);

    public IYouKuISpiderHtmlJob() {
        super(IYouku_I_VideoInfo.class);
    }
    ...
    public void doExecute(Context context) {
        ...
        try {
            ...
            List<IYouku_I_VideoInfo> temp = item.get(IYouku_I_VideoInfo.class.getName());
