...
import com.ifeng.pgc.beans._56VideoPageInfo;
 ...
 */
public class _56PageJob extends AbsHtmlJob {

    private Service<VideoEntityInfo> service;

    public _56PageJob() {
        super(_56VideoPageInfo.class);
    }
    private Logger log = Logger.getLogger(_56PageJob.class);
    @Override
    ...
    public void doExecute(Context context) {
        ...
        try {
            service = BeanLoader.getBean(serviceName);
            _56VideoPageInfo temp = item.get(_56VideoPageInfo.class.getName());
            if (temp != null) {
                VideoEntityInfo mp = new VideoEntityInfo();
                String keywords = "";
