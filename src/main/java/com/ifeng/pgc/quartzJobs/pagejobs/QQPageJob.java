...
import com.ifeng.pgc.beans.QQVideoPageInfo;
 ...
 */
public class QQPageJob extends AbsHtmlJob {

    private Service<VideoEntityInfo> service;
    private Logger log = Logger.getLogger(QQPageJob.class);
    public QQPageJob() {
        super(QQVideoPageInfo.class);
    }
    ...
    public void doExecute(Context context) {
        ...
        try {
            service = BeanLoader.getBean(serviceName);
            QQVideoPageInfo temp = item.get(QQVideoPageInfo.class.getName());
            if (temp != null) {
                VideoEntityInfo mp = new VideoEntityInfo();
                String keywords = "";
