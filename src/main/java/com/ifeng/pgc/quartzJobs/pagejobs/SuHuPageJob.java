...
import com.ifeng.pgc.beans.SohuPageInfo;
 ...
 */
public class SuHuPageJob extends AbsHtmlJob {

    private Service<VideoEntityInfo> service;
    private Logger log = Logger.getLogger(SuHuPageJob.class);
    public SuHuPageJob() {
        super(SohuPageInfo.class);
    }
    ...
    public void doExecute(Context context) {
        ...
        try {
            service = BeanLoader.getBean(serviceName);
            SohuPageInfo temp = item.get(SohuPageInfo.class.getName());
            if (temp != null) {
                VideoEntityInfo mp = new VideoEntityInfo();
                String keywords = "";
