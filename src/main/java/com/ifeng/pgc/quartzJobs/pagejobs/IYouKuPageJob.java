...
import com.ifeng.pgc.beans.IYouKuVideoPageInfo;
 ...
 */
public class IYouKuPageJob extends AbsHtmlJob {

    private Service<VideoEntityInfo> service;
    private Logger log = Logger.getLogger(IYouKuPageJob.class);
    public IYouKuPageJob() {
        super(IYouKuVideoPageInfo.class);
    }
    ...
    public void doExecute(Context context) {
        ...
        try {
            service = BeanLoader.getBean(serviceName);
            IYouKuVideoPageInfo temp = item.get(IYouKuVideoPageInfo.class.getName());
            if (temp != null) {
                VideoEntityInfo mp = new VideoEntityInfo();
                String keywords = "";
