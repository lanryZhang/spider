...
import com.ifeng.pgc.beans.QQVideoPageInfo_3;
 ...
 */
public class QQPageJob_2 extends AbsHtmlJob {

    private Service<VideoEntityInfo> service;
    private Logger log = Logger.getLogger(QQPageJob_2.class);
    public QQPageJob_2() {
        super(QQVideoPageInfo_3.class);
    }
    ...
    public void doExecute(Context context) {
        ...
        try {
            service = BeanLoader.getBean(serviceName);
            QQVideoPageInfo_3 temp = item.get(QQVideoPageInfo_3.class.getName());
            if (temp != null) {
                VideoEntityInfo mp = new VideoEntityInfo();
                String keywords = "";
