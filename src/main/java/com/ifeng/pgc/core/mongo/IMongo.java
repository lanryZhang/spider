...
public interface IMongo {
	...
	<T> List<T> distinct(MongoSelect select, Class<T> classType) throws Exception;
    ...
    UpdateResult inc(Map<String, Object> updateFields, Map<String, Number> incField, Where where, Boolean upsert) throws Exception;
